...
SELECT N'Admin',N'Admin',REPLACE(NEWID(),N'-',N''),NULL,NULL,NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
...
(
	...
	,[ParentIdx] INT DEFAULT 0 NOT NULL
	...
	,INDEX IX_SmartRole_RoleName_ParentIdx NONCLUSTERED(ParentIdx)-- 非聚集索引
)
...
SELECT N'系统开发员角色',0,N'Developer',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'系统管理员角色',0,N'Admin',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'用户操作角色',0,N'Operate',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'数据查询角色',0,N'View',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'审批角色',0,N'Approval',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
...
(
	...
	,INDEX IX_SmartPermission_ParentIdx NONCLUSTERED(ParentIdx)-- 非聚集索引
)

INSERT INTO dbo.SmartPermission
SELECT N'系统管理权限类',0,N'SA',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'我的任务权限类',0,N'SA',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'我的管理权限类',0,N'SA',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
SELECT N'工作积累示例权限类',0,N'SA',NULL,2,GETDATE(),SYSTEM_USER,GETDATE(),SYSTEM_USER
UNION ALL
